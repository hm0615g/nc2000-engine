...
The [T11 follow-up](T11.md) records a withdrawn 30-tree candidate and its interrupted regression experiment. A later [trace of the unchanged search](t11-cause/README.md) follows a concrete source of Hidden Power's optimistic score: more opponent exploration in its fragmented continuation, with exploratory mistakes backed up as root reward. The full causal contribution remains unresolved; no corrective policy has been applied.
